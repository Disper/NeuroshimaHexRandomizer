...
export const hegemony: Army = {
  ...
  tiles: [
    ...
    { id: 'heg-push', name: 'Push', category: 'instant', count: 2, imageUrl: imgOdepchniecie },
    ...
    { id: 'heg-brute', name: 'Brute', category: 'soldier', count: 1, imageUrl: imgBydlak },
    ...
    { id: 'heg-netter', name: 'Netter', category: 'soldier', count: 2, imageUrl: imgSieciarz },
    { id: 'heg-guardian', name: 'Guardian', category: 'soldier', count: 1, imageUrl: imgStraznik },
    { id: 'heg-super-netter', name: 'Super-netter', category: 'soldier', count: 1, imageUrl: imgSupersieciarz },
    { id: 'heg-universal-soldier', name: 'Universal Soldier', category: 'soldier', count: 3, imageUrl: imgUniwersalnyzolnierz },

    // Modules
    { id: 'heg-boss', name: 'Boss', category: 'module', count: 1, imageUrl: imgBoss },
