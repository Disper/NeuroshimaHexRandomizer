...
export const moloch: Army = {
  ...
  tiles: [
    ...
    { id: 'moloch-push', name: 'Push', category: 'instant', count: 5, imageUrl: imgOdepchniecie },
    { id: 'moloch-bomb', name: 'Bomb', category: 'instant', count: 1, imageUrl: imgBomba },
    { id: 'moloch-blocker', name: 'Blocker', category: 'soldier', count: 2, imageUrl: imgBloker },
    { id: 'moloch-cyborg', name: 'Cyborg', category: 'soldier', count: 2, imageUrl: imgCyborg },
    ...
    { id: 'moloch-clown', name: 'Clown', category: 'soldier', count: 1, imageUrl: imgKlaun },
    { id: 'moloch-hunter', name: 'Hunter', category: 'soldier', count: 2, imageUrl: imgLowca },
    { id: 'moloch-defender', name: 'Defender', category: 'soldier', count: 1, imageUrl: imgObronca },
    { id: 'moloch-armored-hunter', name: 'Armored Hunter', category: 'soldier', count: 2, imageUrl: imgOpancerzonylowca },
    { id: 'moloch-armored-sentry', name: 'Armored Sentry', category: 'soldier', count: 1, imageUrl: imgOpancerzonywartownik },
    { id: 'moloch-ripper', name: 'Ripper', category: 'soldier', count: 1, imageUrl: imgRozpruwacz },
    { id: 'moloch-netter', name: 'Netter', category: 'soldier', count: 1, imageUrl: imgSieciarz },
    { id: 'moloch-assault', name: 'Assault Bot', category: 'soldier', count: 1, imageUrl: imgSzturmowiec },
    { id: 'moloch-sentry', name: 'Sentry', category: 'soldier', count: 1, imageUrl: imgWartownik },
    { id: 'moloch-brain', name: 'Brain', category: 'module', count: 1, imageUrl: imgMozg },
    ...
    { id: 'moloch-mother', name: 'Mother', category: 'module', count: 1, imageUrl: imgMatka },
  ],
};
