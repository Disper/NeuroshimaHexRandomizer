...
export const deathBreath: Army = {
  ...
  tiles: [
    // Instant tokens
    { id: 'db-castling', name: 'Castling', category: 'instant', count: 1, imageUrl: imgRoszada },
    { id: 'db-return', name: 'Return', category: 'instant', count: 2, imageUrl: imgPowrot },
    ...
    { id: 'db-grabber', name: 'Grabber', category: 'soldier', count: 3, imageUrl: imgChwytacz },
